...
public class StockAdd {
	...
	public String toString() {
		return new ToStringBuilder(this).append("stock", stock).append("dateAdded", dateAdded).append("price", price)
				.append("numberOfUnits", numberOfUnits).append("additionalProperties", additionalProperties).toString();
	}

	@Override
	public int hashCode() {
		return new HashCodeBuilder().append(price).append(stock).append(additionalProperties).append(dateAdded)
				.append(numberOfUnits).toHashCode();
	}
	...
	public boolean equals(Object other) {
		...
		return new EqualsBuilder().append(price, rhs.price).append(stock, rhs.stock)
				.append(numberOfUnits, rhs.numberOfUnits).append(additionalProperties, rhs.additionalProperties)
				.append(dateAdded, rhs.dateAdded).isEquals();
	}
